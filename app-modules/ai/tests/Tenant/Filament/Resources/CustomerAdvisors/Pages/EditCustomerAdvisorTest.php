...
test('Edit QnA Advisor validates the inputs', function ($data, $errors) {
    ...
    [
        'name required' => [
            CustomerAdvisorRequestFactory::new()->state(['name' => null]),
            ['name' => 'required'],
        ],
        'name string' => [
        ...
        'name max' => [
            CustomerAdvisorRequestFactory::new()->state(['name' => str()->random(258)]),
            ['name' => 'max'],
        ],
        'description required' => [
            CustomerAdvisorRequestFactory::new()->state(['description' => null]),
            ['description' => 'required'],
        ],
        'description max' => [
