...
{
    public function __invoke(Request $request, GetCustomerAdvisorInstructions $getCustomerAdvisorInstructions, CustomerAdvisor $advisor): StreamedResponse | JsonResponse
    {
        ...
        if ($request->query('preview')) {
            ...
            try {
                return new StreamedResponse(
                    $aiService->stream(
                        prompt: $getCustomerAdvisorInstructions->execute($advisor),
